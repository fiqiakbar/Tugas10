...
<body>
    ...
    $error_noijazah = ""; // Nomor Seri ijazah sebelumnya
    $error_hobi = ""; // hobi 
    $error_cita = ""; // 
    // Data Pribadi
    $error_nama = "";
                ...
                <div class="card-body">
                    <form method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="ijazah" class="form-control" <?php echo ($error_noijazah != "" ? "is-invalid" : ""); ?> id="ijazah" placeholder="Silahkan 16 Digit Ijazah SD" pattern="[0-9]{16}" value="<?php echo $ijazah; ?>">
                            </div>
